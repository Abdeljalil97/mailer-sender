...
sender= "localhost"
#password = "ABDELJALILbensoudane1997"
...
PORT = 1025 # assign smtp port
#used to encrypt an SMTP connection
sslcontext = ssl.create_default_context()
# connection to SMTP
connection = smtplib.SMTP("localhost",port=PORT)
...
for rec in receivers:
    rec="abdeljalilbensoudane97@gmail.com"
